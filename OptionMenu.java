    ...
    public void getLogin() {
        ...
        do {
            try {
                ...
                System.out.println("Please register by entering your Customer Number:");
                int newCustomerNumber = menuInput.nextInt();
                
                System.out.println("Enter your PIN:");
                int newPinNumber = menuInput.nextInt();
                
                // Add dynamically entered customer number and PIN to the HashMap
            ...
            if (data.containsKey(cn) && data.get(cn) == pn) {
                ...
                System.out.println("\nWrong Customer Number or PIN. Please try again.\n");
            }
        } while (x == 1);
    }
